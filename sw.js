const CACHE='dunya-al-dawrat-v8-supabase';
const CORE=['./','./index.html','./course.html','./platform.html','./offline.html','./css/style.css','./js/i18n.js','./js/platforms.js','./js/data.js','./js/catalog-core.js','./js/catalog-runtime.js','./js/supabase-config.js','./js/supabase-runtime.js','./js/app.js','./js/detail.js','./js/platform-detail.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
...
self.addEventListener('fetch',event=>{
  ...
  // Large catalog JSON files are loaded only as a fallback when Supabase is unavailable.
